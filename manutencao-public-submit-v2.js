...
function install(){const f=$('public-form');if(!f||f.dataset.submitV2==='1')return;f.dataset.submitV2='1';f.noValidate=true;f.setAttribute('novalidate','novalidate');f.addEventListener('submit',submit,true);const b=$('p-submit');if(b&&!b.dataset.submitV2){b.dataset.submitV2='1';b.addEventListener('click',ev=>{ev.preventDefault();submit(ev)},true)}statusBox()}
